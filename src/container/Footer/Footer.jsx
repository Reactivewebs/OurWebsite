      ...
      <div className="row">
        ...
        <div className="col-md-4 col-12">
          <ul className="info-contact">
            ...
            <li>Email: info@reactivewebs.com</li>
        ...
        <div className="col-md-8 col-12">
          ...
          <form className="row form-news">
            ...
            <div className="col-lg-6 col-12 mt-3 mt-lg-0">
              <button type="submit" className="btn-reactivewebs w-100">Subscribe to news</button>
            </div>
          </form>
        ...
        <div className="rights">
          <p>© 2023 Reactivewebs. All Rights Reserved.</p>

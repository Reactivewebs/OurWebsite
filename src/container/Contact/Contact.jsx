  ...
  return (
    <div classNameName="section-padding">
      ...
      <div className="contact" id="quote">
        ...
        <div style={{ borderRadius: '15px', padding: '10px' }} className="row">
          <div className="col-md-6 col-12" style={{ borderRadius: '15px' }}>
            <form>
              ...
              <button type="submit" class="btn-reactivewebs w-100">Submit</button>
            </form>
          </div>
        </div>
      </div>
